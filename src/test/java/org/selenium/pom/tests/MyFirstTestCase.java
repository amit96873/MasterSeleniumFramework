...
public class MyFirstTestCase extends BaseTest {
    ...
    @Story("sanity testing till search results page")
    ...
    @Description("Login with valid credential and go for the dashboard page and then click on flight options and then it should get in to flight search page and do some operations and then able to search the flights and get in to search results page")
